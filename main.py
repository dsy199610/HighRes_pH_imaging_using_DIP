...
def main_evaluate(args):
    ...
    with torch.no_grad():
        for iter, data in enumerate(loader):
            ...
            logging.info(f'{rabbit[0]} {slice[0]} MAE (recon)={MAE_recon}')
            ...
            np.savez(output_file, pH_clean=pH_clean, pH_recon=outputs, pH_SR=outputs_SR, T1=T1, T2=T2, DWI=DWI)
...
def create_arg_parser():
    ...
    parser.add_argument('--rabbit', type=str, default=['Maro'], help='Rabbit name')
